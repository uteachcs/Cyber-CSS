...
<div class="container">
	...
	<div class="row justify-content-center">
		<div class="col col-md-3">
			<img class="img-fluid" src=".guides/img/image24.png" alt="UTeach approximation" >
		</div>
		<div class="col col-md-3">
...
## Bootstrap Table
<table class="tableBoot tableBoot-bordered "><caption style="display: none">Scratch vs Python Concatenation Blocks</caption>
<thead class="thead-light">
<tr>
<th style="width: 100%; text-align: center;" scope="col">Scratch Block</th>
<th style="width: 100%; text-align: center;" scope="col">Python</th>
</tr>
</thead>
<tbody>
<tr>
<td style="width: 100%;"> <img src=".guides/img/joinexample.png" alt="Example of join block" /> </td>
<td style="width: 100%;"><pre>name = "Carly"<br />print("Hi " + name + ", nice to meet you!")<br /> &gt;&gt;&gt; Hi Carly, nice to meet you!</pre> </td>
</tr>
</tbody>
</table>
